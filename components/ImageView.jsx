...
export default function ImageView(props) {
    ...
    return (
        <Layout style={{width: Dimensions.get('window').width, flex: 1, flexDirection: 'column', justifyContent: 'space-evenly', alignItems: 'center'}}>
          <View style={{backgroundColor: 'grey' , flex: 1, flexDirection: 'column', justifyContent: 'space-around', alignItems: 'center', padding: 25}}>
            {item.uri === '+' ? <View style={{width: Dimensions.get('window').width - 100 > 350 ? 350 : Dimensions.get('window').width - 100, flex: 1, flexDirection: 'column', justifyContent: 'space-around', alignItems: 'center'}}>
            ...
            <>
            <Layout>
                <Input style={{width: Dimensions.get('window').width - 100 > 350 ? 350 : Dimensions.get('window').width - 100}} onChangeText={value => 
                    {
                        item.name = value;
